...
for y in range(y_start, y_end+1):
    ...
    for m in monthlist:
        ...
        m = str(m).rjust(2, '0')
        ma_path = f"/Users/sarinatan/Desktop/HLTH470/homework1/data/MA_Cnty_SA_2015_01.csv"
...
contract_service_area.to_csv("/Users/sarinatan/Desktop/HLTH470/homework1/submission2/data-code/output/contract_service_area.csv", index=False)