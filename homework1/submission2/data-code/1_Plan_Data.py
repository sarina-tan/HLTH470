...
for y in range(y_start, y_end+1):
    ...
    ma_path = f"/Users/sarinatan/Desktop/HLTH470/homework1/data/CPSC_Contract_Info_2015_01.csv"
    print(os.path.join(os.getcwd(), ma_path))
    ...
    ma_path = f"/Users/sarinatan/Desktop/HLTH470/homework1/data/CPSC_Enrollment_Info_2015_01.csv"
...
# print(os.path.exists(os.path.join(os.getcwd(), "output")))
full_ma_data.to_csv("/Users/sarinatan/Desktop/HLTH470/homework1/submission2/data-code/output/full_ma_data.csv", index=False)